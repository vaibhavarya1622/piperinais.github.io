...
document.querySelector(".btn-ref p").innerHTML = "Toca la bombilla Miss Universo😊";
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        light.play();
        transition(blackbox);
        document.querySelector(".btn-ref p").innerHTML = "haga clic en la puerta Piperinais";
        setTimeout(function() {
        ...
        */
        ...
        door.play();
        transition(hallway);
        document.querySelector(".btn-ref p").innerHTML = "haga clic en el regalo Princesa balboa👸";
        setTimeout(function() {
